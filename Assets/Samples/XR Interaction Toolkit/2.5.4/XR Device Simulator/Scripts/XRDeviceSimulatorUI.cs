...
namespace UnityEngine.XR.Interaction.Toolkit.Samples.DeviceSimulator
{
    class XRDeviceSimulatorUI : MonoBehaviour
    {
        ...
        void Initialize()
        {
            ...
            catch (System.Exception __vrPatchEx)
            {
                Debug.LogWarning("[XRDeviceSimulatorUI] Initialize parcial (bug do sample XRI 2.5.4 quando uma action ainda nao resolveu controles): " + __vrPatchEx.Message);
            }
        }
        ...
        void UpdateDeviceInputMethod()
        {
            ...
            {
                Debug.LogWarning("[XRDeviceSimulatorUI] UpdateDeviceInputMethod parcial: " + __vrPatchEx.Message);
            }
        }
